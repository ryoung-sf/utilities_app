  ...
  context "when user has no authorized billing accounts" do
    ...
    it "submits new account request Form" do
      ...
      headers = {
        ...
        'Authorization'=>'bearer 16532b3473754a19ae044a78c3367324',
      ...
      stub_request(:post, "https://utilityapi.com/api/v2/forms")
        .with(
          body: { customer_email: "user-100@example.com", utility: "DEMO" }.to_json,
          headers: 
        )
        .to_return(
          status: 200,
      ...
      stub_request(:get, "https://utilityapi.com/api/v2/authorizations").
        ...
        to_return(
          status: 200,
          body: File.open("./spec/support/fixtures/authorizations/one_authorization.json"),
          headers:
        )
